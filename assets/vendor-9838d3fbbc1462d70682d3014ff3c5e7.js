...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,classNames:["x-dragula"],init:function(){this._super.apply(this,arguments),this.set("drake",(0,n.default)([],Ember.assign({},this.get("options"))))},willDestroyElement:function(){this._super.apply(this,arguments),this.get("drake").destroy()},actions:{addChild:function(e){var t=this
